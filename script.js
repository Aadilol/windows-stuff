...
function openImageWindow(windowId) {
    ...
    var x = Math.max(0, Math.min(centerX, window.innerWidth - imageWindow.offsetWidth)) - 50;
    var y = Math.max(0, Math.min(centerY, window.innerHeight - imageWindow.offsetHeight)) - 100;
